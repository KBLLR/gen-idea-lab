...
import StellarScene from './stellar/StellarScene.jsx';
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                        ...
                        <div style={{ marginLeft: 'auto' }}>
                          <ActionBar
                            ...
                            items={[
                              { key: 'save', title: 'Save', icon: 'save', onClick: handleSave },
                              { key: 'upload', title: 'Upload Background', icon: 'upload', onClick: handleUploadClick },
                              { key: 'gallery', title: 'Gallery', icon: 'photo_library', onClick: handleOpenGallery }
                            ]}
                          />
                        </div>
                    </div>
