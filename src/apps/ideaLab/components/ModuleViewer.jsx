...
import { personalities } from '@shared/lib/assistant/personalities';
...
const toggleKnowledge = useStore((s) => s.actions?.toggleKnowledgeSection);
    const setActiveAppAction = useStore((s) => s.actions?.setActiveApp);
            ...
            <div className="module-viewer-header">
                ...
                <div className="module-connectors">
                    {(() => {
                        ...
                        items.push({ id: 'docs', label: 'Documentation', icon: 'description', onClick: () => {} });
items.push({ id: 'kb', label: 'Knowledge', icon: 'database', onClick: () => toggleKnowledge?.() });
                        items.push({ id: 'chat', label: 'Chat', icon: 'chat', onClick: () => { setActiveAppAction?.('chat'); navigate(getAppPath('chat')); } });
                        return <ActionBar items={items} aria-label="Module actions" />;
                    })()}
                </div>
            </div>
            <div className="module-viewer-content">
                ...
                <div>
                    ...
                    <div className="topic-tags">
                        {disciplineInfo.keyTopics.map((topic) => (
                ...
                <div>
                    ...
                    <ul>
                        {disciplineInfo.applications.map((app) => <li key={app}>{app}</li>)}
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul>
                        {module['Qualification Objectives'].map((obj) => <li key={obj}>{obj}</li>)}
                    </ul>
                </div>
            </div>
